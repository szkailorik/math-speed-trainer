...
const xiyoujiEasyMonsters = [
    ...
    // v16.0 新增怪兽
    {
        id: 'xiao_shanzha', name: '小山渣', nameEn: 'Little Mountain Imp',
        emoji: '🪨', hp: 3, type: 'earth',
        difficulty: 'easy',
        personality: 'timid',
        story: '小山渣是狮驼岭最底层的巡山小妖，连小钻风都可以欺负它。它胆子特别小，听到悟空的名字就吓得石化——不是比喻，是真的会因为害怕而全身僵硬变成石头。被打中后它会分裂成更小的石块四处逃窜，每块石块上还刻着小数点题目。',
        enterQuips: ['呜...小山渣不想打架...', '大...大王叫我来的...我能回去吗...'],
        deathQuips: ['碎了...终于不用巡山了...', '呜...回不了家了...'],
        tauntQuips: ['你...你别打了...我投降...', '小山渣虽弱...也有尊严的...'],
        fearQuips: ['妈呀！要碎了要碎了！', '救命——大王——！'],
        behaviors: ['split'],
        attackEmoji: '🪨'
    },
    {
        id: 'yao_feng_ling', name: '妖风灵', nameEn: 'Demon Wind Spirit',
        emoji: '🌬️', hp: 3, type: 'wind',
        difficulty: 'easy',
        personality: 'cunning',
        story: '妖风灵是黄风怪释放三昧神风时不小心吹出来的一小缕妖风，获得了自己的意识。它轻飘飘的到处飘，最擅长在你快要算出小数答案的时候吹乱你的头发遮住眼睛。它的身体是风做的，攻击经常穿过它的身体，让人很头疼。',
        enterQuips: ['呼~妖风灵飘来了~', '风里来风里去~抓不住我~'],
        deathQuips: ['风...散了...', '呼...最后一阵风...'],
        tauntQuips: ['哈哈，打偏了~', '风是抓不住的~'],
        fearQuips: ['怎么可能命中我！', '风...停不下来了！'],
        behaviors: ['dodge'],
        attackEmoji: '💨'
    }
];
